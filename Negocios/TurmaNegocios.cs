        ...
        public TurmaColecao ConsultarPorNome(string nome)
        {
            try
            {
                ...
                foreach (DataRow dataRow in dataTable.Rows)
                {
                    ...
                    turma.Hora_Inicio = DateTime.ParseExact(dataRow["HORA_INICIO"].ToString(), "HH:mm:ss", null, System.Globalization.DateTimeStyles.None);
                    turma.Hora_Fim = DateTime.ParseExact(dataRow["HORA_FIM"].ToString(), "HH:mm:ss", null, System.Globalization.DateTimeStyles.None);
