...
namespace Apresentacao.Presentation.Popup.SearchDialogs
{
    ...
    public partial class SearchDialog_Pessoa_Atendimento : Form
    {
        ...
        public SearchDialog_Pessoa_Atendimento()
        {
            InitializeComponent();
        ...
        private void btnNovo_Click(object sender, EventArgs e)
        {
            ...
            else if (btnNovo.Text == "Salvar")
            {
                ...
                try
                {
                    ...
                    AdicionarEditarAtendimento.PessoaGetSet = pessoaCadastrada;
