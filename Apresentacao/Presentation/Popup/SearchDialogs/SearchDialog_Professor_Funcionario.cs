...
namespace Apresentacao.Presentation.Popup.SearchDialogs
{
    ...
    public partial class SearchDialog_Professor_Funcionario : Form
    {
        Funcionario funcionarioEscolhido = new Funcionario();

        public SearchDialog_Professor_Funcionario()
        {
            InitializeComponent();
        ...
        {
            AdicionarEditarProfessor.FuncionarioGetSet = funcionarioEscolhido;
            AdicionarEditarProfessor.atualizarCamposFuncinario = true;
            this.Close();
        }
