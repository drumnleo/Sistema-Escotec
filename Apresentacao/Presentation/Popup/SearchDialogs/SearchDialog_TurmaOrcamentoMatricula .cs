...
namespace Apresentacao.Presentation.Popup.SearchDialogs
{
    ...
    public partial class SearchDialog_TurmaOrcamentoMatricula : Form
    {
        TurmaOrcamento turmaOrcamentoEscolhido = new TurmaOrcamento();

        public SearchDialog_TurmaOrcamentoMatricula()
        {
            InitializeComponent();
        ...
        {
            bool isNumeric = int.TryParse(tbxSearch.Text, out _);
            TurmaOrcamentoNegocios turmaOrcamentoNegocios = new TurmaOrcamentoNegocios();
            _ = new TurmaOrcamentoColecao();
            TurmaOrcamentoColecao turmaOrcamentos;
            if (isNumeric)
            {
                turmaOrcamentos = turmaOrcamentoNegocios.ConsultarPorCpf(tbxSearch.Text);
            }
            else
            {
                turmaOrcamentos = turmaOrcamentoNegocios.ConsultarPorPessoa(tbxSearch.Text);
            }
        ...
        {
            AdicionarEditarMatricula.DesabilitaTimer = true;
            this.Close();
        }

        private void btnSelecionar_Click(object sender, EventArgs e)
        {
            AdicionarEditarMatricula.TurmaOrcamentoGetSet = turmaOrcamentoEscolhido;
            AdicionarEditarMatricula.AtualizaDatagrid = true;
